...
import C2eMdCopyrightsLd from "./classes/C2eMdCopyrightsLd";
...
const c2eMdCopyrightsLd = new C2eMdCopyrightsLd('c2ens:c2eid-xxx/metadata/copyRights', 'sdons:Dataset', c2eLicenseDigitalDocumentLd, c2eMdCopyrightHolderLd, 'This C2E has all rights to Waqar Muneer', '2023');

const C2eMetadata = new C2eMetadataLd('c2ens:c2eid-xxx/metadata', 'sdons:Dataset', c2eMdGeneralLd, c2eAuthorLd, c2eMdCopyrightsLd);
